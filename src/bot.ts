...
import type { Session as FlowSession } from "./lib/session.js";

// Ephemeral conversation state only. Durable domain data uses src/lib/store.ts.
export type Session = FlowSession;
